...
public class Remover {
    ...
    //remover garcon
    public static void removerGarcon(ArrayList garcon,  ArrayList password, ArrayList idade, ArrayList morada, 
    ...
    public static void removerPrato(ArrayList prato,  ArrayList id, ArrayList categ, ArrayList preco,
