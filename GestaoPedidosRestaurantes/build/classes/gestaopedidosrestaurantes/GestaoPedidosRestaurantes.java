...
public class GestaoPedidosRestaurantes {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //configuraões do JOptionPane
            UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("SansSerif", Font.PLAIN, 14)));
            ...
            switch (op) {
                case 1:
                    ...
                    do {
                        ...
                        switch (op1) {
                            case 1:
                                addPrato(pratos, idPratos, categ, preco, txtPratos, txtIdPratos, txtCateg, txtPreco);break;
                            case 2:
                                listarPratos(pratos, idPratos, categ, preco);break;
                            case 3:
                                alterarPratos(pratos, idPratos, categ, preco, txtPratos, txtIdPratos, txtCateg, txtPreco);break;
                            case 4:
                                removerPrato(pratos, idPratos, categ, preco, txtPratos, txtIdPratos, txtCateg, txtPreco); break;
                            case 0:
                                break;
                            default:
                    ...
                    break;
                case 2:
                    cardapio(pratos, idade, categ, preco, pedidos, txtPedidos);break;
                case 3:
                    pedidos(pratos, idPratos, categ, preco, garcon, pedidos, fatura, txtPedidos, txtFatura); break;
                case 4:
                    int op2;
                    ...
                    do {
                        ...
                        switch (op2) {
                            case 1:
                                adicionarGarcon(garcon, password, idade, morada, sexo, telef, txtGarcon, txtPassword, txtIdade,  txtMorada, txtSexo, txtTelef); break;
                            case 2:
                                listarGarcon(garcon, idade, morada, sexo, telef);break;
                            case 3:
                                alterarGarcon(garcon,  password, morada, telef, txtGarcon, txtPassword, txtMorada, txtTelef) ;break;
                            case 4:
                                removerGarcon(garcon,  password, idade, morada, sexo, telef, txtGarcon, txtPassword, txtIdade,  txtMorada, txtSexo,  txtTelef);break;
                            case 0:
                                break;
                            default:
                                JOptionPane.showMessageDialog(null, "Opção Inválida!", "ERRO", JOptionPane.ERROR_MESSAGE);
