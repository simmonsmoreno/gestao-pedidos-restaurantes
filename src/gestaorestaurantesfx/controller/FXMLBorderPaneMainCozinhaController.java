 ...
 * @author pc
 */
public class FXMLBorderPaneMainCozinhaController implements Initializable {
    ...
    @FXML
    private void handlePratos(MouseEvent event) {
        carregarTela("Pratos");
    ...
    private void carregarTela(String tela){
        ...
        try {
            ...
            Logger.getLogger(FXMLBorderPaneMainCozinhaController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
