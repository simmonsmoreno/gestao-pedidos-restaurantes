 ...
 * @author pc
 */
public class FXMLEstatisticasSempreController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        lblLucroTotal.setText(Integer.toString(new EstatisticasDAO().estatisticasSempre().getLucroTotal()));
        lblTotalPedido.setText(Integer.toString(new EstatisticasDAO().estatisticasSempre().getTotalPedido()));
    ...
    public void carregartableViewEstatisticasPratos(){
        ...
        estatisticas = new EstatisticasDAO().estatisticasSempre();
