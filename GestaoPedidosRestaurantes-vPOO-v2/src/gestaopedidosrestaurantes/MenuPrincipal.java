...
public class MenuPrincipal{
    ...
    public static void MenuAdministrador(ArrayList<Prato> pratos, ArrayList<Funcionario> funcionarios, ArrayList<Pedido> pedidos, Funcionario funcionarioOnline) throws IOException{
        ...
        do{
            ...
            System.out.println("======================================================================");
            System.out.print  (">> "); 
            try{ opcao = scan.nextInt();
            }catch(InputMismatchException e){ JOptionPane.showMessageDialog(null, "Introduza uma opção válida!"+e.getMessage());}
            ...
            switch (opcao) {
                ...
                case 2: 
                    ...
                    opcao=2;
                    break;
                case 3: historico(pedidos, pratos, funcionarios, funcionarioOnline); break;
                ...
                case 2: 
                    do{
                        ...
                        switch (opcao) {
                            ...
                            case 2: entregarPedidos(pedidos, pratos, funcionarios);break;
                            case 0: break;
                            default: JOptionPane.showMessageDialog(null, "Opção Inválida!");
                        }
                    }while (opcao!=0);
        ...
        do{
            ...
            switch (opcao) {
                case 1: 
                    ...
                    opcao=1;
                    break;
                case 2: processarPedidos(pedidos, pratos, funcionarios, funcionarioOnline);break;
                case 3: historico(pedidos, pratos, funcionarios, funcionarioOnline);break;
                case 4: editarPerfil(funcionarios, funcionarioOnline); break;
                case 0: break;
                default: JOptionPane.showMessageDialog(null, "Opção Inválida!");
