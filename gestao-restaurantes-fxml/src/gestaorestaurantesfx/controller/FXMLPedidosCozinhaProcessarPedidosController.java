 ...
 * @author pc
 */
public class FXMLPedidosCozinhaProcessarPedidosController implements Initializable {
    ...
    @FXML private void processarPedidos(MouseEvent event) {
        Pedidos p = tableViewPedidos.getSelectionModel().getSelectedItem();
