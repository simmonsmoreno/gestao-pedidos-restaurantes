...
public class HistoricoPedidos {
    ...
    public static void historico(ArrayList <Pedido> pedidos, ArrayList <Funcionario> funcionarios, Funcionario funcOnline){
            ...
            if(pedidos.isEmpty()) System.out.println("Nenhum pedido feito!");
                ...
                if(funcOnline.getCargo().equals("administrador")){
                    for(Pedido pedido:pedidos){
                        if(pedido.isEntregue()) System.out.println(pedido.showPedido(funcionarios));
                        else{
