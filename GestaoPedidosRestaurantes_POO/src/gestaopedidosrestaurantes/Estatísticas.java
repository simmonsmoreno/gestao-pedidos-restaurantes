        ...
        if(naoEncontrou){
            ...
            try {
                ...
                for(Funcionario funcionario:funcionarios){
                    for(Pedido pedido:pedidos){
                        if(funcionario.getId()==(pedido.getIdGarcom())) i++;
                    }
                    if(i>maiorGarcom){
                        maiorGarcom=i;
                ...
                for(Funcionario funcionario:funcionarios){
                    for(Pedido pedido:pedidos){
                        if(funcionario.getId()==(pedido.getIdCozinheiro())) i++;
                    }
